...
router.post(
  ...
  body("director")
    ...
    .isAlpha()
    .withMessage("Director should start with an alphabetical letter"),
  body("year")
    .trim()
    .notEmpty()
    ...
    .withMessage("Year should be a four-digit number"),
    ...
    try {
      ...
      if (yearInt < 1900 || yearInt > 2100) {
        return res
          .status(400)
          .render("movies/new", {
            errors: [{ msg: "Year should be between 1900 and 2100" }],
            title,
            director,
            year,
            notes,
    ...
    try {
      ...
      if (!errors.isEmpty()) {
        return res
          ...
          .render("movies/edit", {
            errors: errors.array(),
            movie: { _id: req.params.id, title, director, year, notes },
          });
      }
